...
defined?(ActiveJob) &&
  describe("ActiveJob Enqueue integration", :active_job_enqueue_probe, :agent) do
    ...
    before do
      ...
      @job_class =
        ActionMailer::Base.respond_to?(:delivery_job) ? ActionMailer::Base.delivery_job : ActionMailer::DeliveryJob
