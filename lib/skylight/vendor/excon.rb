...
module Skylight
  module Vendor
    ...
    require 'skylight/vendor/excon/constants'
    require 'skylight/vendor/excon/connection'
    require 'skylight/vendor/excon/errors'
    require 'skylight/vendor/excon/middlewares/base'
    require 'skylight/vendor/excon/middlewares/expects'
    require 'skylight/vendor/excon/middlewares/instrumentor'
    require 'skylight/vendor/excon/middlewares/mock'
    require 'skylight/vendor/excon/response'
    require 'skylight/vendor/excon/socket'
    require 'skylight/vendor/excon/ssl_socket'
    require 'skylight/vendor/excon/standard_instrumentor'
